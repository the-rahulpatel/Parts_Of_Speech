...
# What I learnt
I have learnt to integrate system variables in python through 'import os', undestand the importance of virtual environments, secure my API keys when deploying this online, and parse JSON in python. 
